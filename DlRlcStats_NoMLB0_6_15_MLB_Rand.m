...
array2 = csvread('/home/ahmasri/ns-allinone-3.26/ns-3.26/Official_collection_Of_Results/MLB/Run_13p/DlRlcStats.csv');
...
UEdata = [AvgUePerCellPerSec1 AvgUePerCellPerSec2 AvgUePerCellPerSec3 AvgUePerCellPerSec4 AvgUePerCellPerSec5 ];
...
legend ({'NoMLB-H0', 'NoMLB-H6', 'NoMLB-H15', 'NoMLB-HRand', 'MLB-HRand'}, 'location', 'northeastoutside');
...
%write it a file
plot_data2 = [(Thr1*8/1000) (Thr2*8/1000) (Thr3*8/1000) (Thr4*8/1000) (Thr5*8/1000)];
...
saveas(f1,'Plots/DlRlcStats_NoMLB0_6_15_MLB_Rand_Thr_and_NumUEs_Linear.png');  % Save plot
savefig('Plots/DlRlcStats_NoMLB0_6_15_MLB_Rand_Thr_and_NumUEs_Linear.fig');
...
bar(tmp');
hold on;
set (gca, 'xticklabel', {'NoMLB-H0', 'NoMLB-H6', 'NoMLB-H15', 'NoMLB-HRand', 'MLB-HRand'})
...
title ('Using N = 150, Speed = 5 m/sec, Distance 750 m, TxPower = 43.0 dBm  ');
%set (h2, 'fontsize', 12);
saveas(f2,'Plots/DlRlcStats_NoMLB0_6_15_MLB_Rand_GlobalThr.png');  % Save plot
savefig('Plots/DlRlcStats_NoMLB0_6_15_MLB_Rand_GlobalThr.fig');
...
title ('Using N = 150, Speed = 5 m/sec, Distance 750 m, TxPower = 43.0 dBm  ');
%set (h2, 'fontsize', 12);
saveas(f3,'Plots/DlRlcStats_NoMLB0_6_15_MLB_Rand_GlobalNumUEs.png');  % Save plot
savefig('Plots/DlRlcStats_NoMLB0_6_15_MLB_Rand_GlobalNumUEs.fig');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Figure Four%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 legend ({'NoMLB-H0', 'NoMLB-H6', 'NoMLB-H15', 'NoMLB-HRand', 'MLB-HRand'}, 'location', 'best');
 
 title ('Using N = 150, Speed = 5 m/sec, Distance 750 m, TxPower = 43.0 dBm  ');
 saveas(f4,'Plots/DlRlcStats_NoMLB0_6_15_MLB_Rand_Thr_Bars.png');  % Save plot
 savefig('Plots/DlRlcStats_NoMLB0_6_15_MLB_Rand_Thr_Bars.fig');
...
f5 = figure('Name', 'Number of UEs', 'NumberTitle', 'off');           % Figure  
 ...
 saveas(f5,'Plots/DlRlcStats_NoMLB0_6_15_MLB_Rand_NumUEs_Bars.png');  % Save plot
  savefig('Plots/DlRlcStats_NoMLB0_6_15_MLB_Rand_NumUEs_Bars.fig');
