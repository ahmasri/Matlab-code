clear all;
array1 = csvread('/home/ahmasri/ns-allinone-3.26/ns-3.26/Official_collection_Of_Results/MLB/Run_18p/DlRlcStats.csv');
array2 = csvread('/home/ahmasri/ns-allinone-3.26/ns-3.26/Official_collection_Of_Results/MLB/Run_24p/DlRlcStats.csv');
array3 = csvread('/home/ahmasri/ns-allinone-3.26/ns-3.26/Official_collection_Of_Results/MLB/Run_19p/DlRlcStats.csv');
array4 = csvread('/home/ahmasri/ns-allinone-3.26/ns-3.26/Official_collection_Of_Results/MLB/Run_25p/DlRlcStats.csv');
...
f1 = figure('Name', 'Throughput/Number of UEs', 'NumberTitle', 'off');           % Figure          
...
legend ({'NoMLB-H0', 'MLB-H0', 'NoMLB-H15', 'MLB-H15', 'NoMLB-HRand', 'MLB-HRand'}, 'location', 'northeastoutside');
...
%csvwrite('MlbVsNoMlb_0_15_Rand_Thr.csv',plot_data);
...
saveas(f1,'Plots/DlRlcStats_MlbVsNoMlb_0_15_Rand_thr_and_NumUEs_Linear.png');  % Save plot
savefig('Plots/DlRlcStats_MlbVsNoMlb_0_15_Rand_thr_and_NumUEs_Linear.fig');
...
bar(tmp');
hold on;
set (gca, 'xticklabel', {'NoMLB-H0', 'MLB-H0', 'NoMLB-H15', 'MLB-H15', 'NoMLB-HRand', 'MLB-HRand'})
...
%set (h2, 'fontsize', 12);
saveas(f2,'Plots/DlRlcStats_MlbVsNoMlb_0_15_Rand_GlobalThr_Bars.png');  % Save plot
savefig('Plots/DlRlcStats_MlbVsNoMlb_0_15_Rand_GlobalThr_Bars.fig');
...
title ('Using N = 150, Speed = 5 m/sec, Distance 750m, TxPower = 43.0 dBm  ');
%set (h2, 'fontsize', 12);
saveas(f3,'Plots/DlRlcStats_MlbVsNoMlb_0_15_Rand_GlobalNumUEs_Bars.png');  % Save plot
savefig('Plots/DlRlcStats_MlbVsNoMlb_0_15_Rand_GlobalNumUEs_Bars.fig');
 ...
 legend ({'NoMLB-H0', 'MLB-H0', 'NoMLB-H15', 'MLB-H15', 'NoMLB-HRand', 'MLB-HRand'}, 'location', 'best');
 
 title ('Using N = 150, Speed = 5 m/sec, Distance 750m, TxPower = 43.0 dBm  ');
 saveas(f4,'Plots/DlRlcStats_MlbVsNoMlb_0_15_Rand_Thr_bars.png');  % Save plot
  savefig('Plots/DlRlcStats_MlbVsNoMlb_0_15_Rand_Thr_Bars.fig');
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Figure Five%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
     ...
     saveas(f3,'Plots/DlRlcStats_MlbVsNoMlb_0_15_Rand_NumUEs_Bars.png');  % Save plot
     savefig('Plots/DlRlcStats_MlbVsNoMlb_0_15_Rand_NumUEs_Bars.fig');
