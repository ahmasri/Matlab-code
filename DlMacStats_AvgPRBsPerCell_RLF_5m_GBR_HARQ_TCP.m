...
clear;
array1 = csvread('/home/ahmasri/ns-allinone-3.26/ns-3.26/Official_collection_Of_Results/RLF/Run_14/DlMacStats.txt');
array2 = csvread('/home/ahmasri/ns-allinone-3.26/ns-3.26/Official_collection_Of_Results/RLF/Run_15/DlMacStats.txt');
...
tmp1    =   mean(avgPRB1(1:23),'omitnan');
tmp2    =   mean(avgPRB1(23:47),'omitnan');
tmp3    =   mean(avgPRB2(1:23),'omitnan');
tmp4    =   mean(avgPRB2(23:47),'omitnan');
...
line ([0 25]   ,    [tmp1 tmp1], 'LineWidth', 2, 'linestyle', ':', 'color', 'b');
 line ([0 25]   ,    [tmp3 tmp3], 'LineWidth', 2, 'linestyle', '-.', 'color', 'r');
 legend ({'NoCOC', 'COC', 'Global NoCOC','Global COC'}, 'location', 'best');
 hold on;
 line ([25 50] ,    [tmp2 tmp2], 'LineWidth', 2, 'linestyle', ':', 'color', 'b');
 line ([25 50] ,    [tmp4 tmp4], 'LineWidth', 2, 'linestyle', '-.', 'color', 'r');
%  
