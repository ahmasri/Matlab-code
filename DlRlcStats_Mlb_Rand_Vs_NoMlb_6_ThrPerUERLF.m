...
saveas(f1,'Plots/DlRlcStats_Mlb_Rand_Vs_NoMlb_6_ThrPerUE_10m_LinearRLF.png');  % Save plot
savefig('Plots/DlRlcStats_Mlb_Rand_Vs_NoMlb_6_ThrPerUE_10m_LinearRLF.fig');
...
%set (h2, 'fontsize', 12);
saveas(f2,'Plots/DlRlcStats_Mlb_Rand_Vs_NoMlb_6_GlobalThrPerUE_10mRLF.png');  % Save plot
savefig('Plots/DlRlcStats_Mlb_Rand_Vs_NoMlb_6_GlobalThrPerUE_10mRLF.fig');
 ...
 saveas(f3,'Plots/DlRlcStats_Mlb_Rand_Vs_NoMlb_6_ThrPerUE_10m_BarsRLF.png');  % Save plot
 savefig('Plots/DlRlcStats_Mlb_Rand_Vs_NoMlb_6_ThrPerUE_10m_BarsRLF.fig');
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Figure Three%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 f3 = figure('Name', 'Average Throughput', 'NumberTitle', 'off');           % Figure  
 ...
 saveas(f3,'Plots/DlRlcStats_Mlb_Rand_Vs_NoMlb_6_ThrPerUE_10m_Bars_PercentRLF.png');  % Save plot
 savefig('Plots/DlRlcStats_Mlb_Rand_Vs_NoMlb_6_ThrPerUE_10m_Bars_PercentRLF.fig');
