...
Dtmp1    =   mean(GlobalAvgNumUEs1(1:789),'omitnan');
Dtmp2    =   mean(GlobalAvgNumUEs1(789:1187),'omitnan');

Dtmp3    =   mean(GlobalAvgNumUEs2(1:789),'omitnan');
Dtmp4    =   mean(GlobalAvgNumUEs2(789:1187),'omitnan') ;
...
hold on;
line ([200 300] ,    [Dtmp2 Dtmp2], 'LineWidth', 3, 'linestyle', ':', 'color', 'b');
line ([200 300] ,    [Dtmp4 Dtmp4], 'LineWidth', 3, 'linestyle', '-.', 'color', 'r');

saveas(f1,'Plots/DlRlcStats_CoC_Vs_NoCOC_NumUE_5m_Linear_VsTimeRLF_TCP_HARQ_5m.png');  % Save plot
savefig('Plots/DlRlcStats_CoC_Vs_NoCOC_NumUE_5m_Linear_VsTimeRLF_TCP_HARQ_5m.fig');
